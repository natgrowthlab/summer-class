...
async function initDB() {
  const schema = [
    `CREATE TABLE IF NOT EXISTS students (id UUID PRIMARY KEY, email TEXT UNIQUE NOT NULL, password_hash TEXT, first_name TEXT NOT NULL, last_name TEXT NOT NULL, phone TEXT NOT NULL, grade TEXT NOT NULL, city TEXT NOT NULL, school TEXT NOT NULL, created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP)`,
  ...
  await nativePool.query('ALTER TABLE students ADD COLUMN IF NOT EXISTS password_hash TEXT');
